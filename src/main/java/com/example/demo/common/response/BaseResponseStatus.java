...
public enum BaseResponseStatus {
    ...
    USERS_EMPTY_LOGIN_ID(false, HttpStatus.BAD_REQUEST.value(), "아이디를 입력해주세요."),
    POST_USERS_INVALID_LOGIN_ID(false, HttpStatus.BAD_REQUEST.value(), "아이디 형식을 확인해주세요."),
    ...
    POST_USERS_INVALID_PHONE_NUMBER(false, HttpStatus.BAD_REQUEST.value(), "휴대폰 번호 형식을 확인해주세요."),
    POST_USERS_INVALID_PASSWORD(false, HttpStatus.BAD_REQUEST.value(), "비밀번호는 6자 이상 20자 이하여야 합니다."),
    POST_USERS_INVALID_NAME(false, HttpStatus.BAD_REQUEST.value(), "이름은 20자 이하여야 합니다."),
    POST_USERS_INVALID_BIRTHDATE(false, HttpStatus.BAD_REQUEST.value(), "생년월일을 확인해주세요."),
    POST_USERS_RESTRICTED_AGE(false, HttpStatus.BAD_REQUEST.value(), "만 8세 이상만 가입 가능합니다."),
    POST_USERS_NOT_AGREED_TERMS(false, HttpStatus.BAD_REQUEST.value(), "필수 약관에 모두 동의해야 합니다."),
